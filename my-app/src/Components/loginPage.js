                        ...
                        <ul className="nav nav-tabs" role="tablist">
                            <li className="nav-item">
                                <a className="nav-link" data-toggle="tab" href="#home" role="tab" aria-expanded="false">
                                    <svg className="olymp-login-icon"><use xlinkHref="icons/icons.svg#olymp-login-icon" /></svg>
                                    <div className="ripple-container" /></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link active" data-toggle="tab" href="#profile" role="tab" aria-expanded="true">
                                    <svg className="olymp-register-icon"><use xlinkHref="icons/icons.svg#olymp-register-icon" /></svg>
                                    <div className="ripple-container" /></a>
                            </li>
                        </ul>
                        {/* Tab panes */}
                                ...
                                <form className="content">
                                    <div className="row">
                                        <div className="col-xl-12 col-lg-12 col-md-12">
                                            ...
                                            <div className="or" />
                                            <a href="http://localhost:5000/login/microsoft" className="btn btn-lg bg-twitter full-width btn-icon-left"><i className="fa fa-twitter" aria-hidden="true" />Login with Outlook</a>
