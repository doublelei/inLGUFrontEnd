...
function Days(props) {
	const first = props.first.map((day) => <td date-month="12" date-day={day}>{day}</td>);
	const second = props.second.map((day) => <td date-month="12" date-day={day}>{day}</td>);
	const third = props.third.map((day) => <td date-month="12" date-day={day}>{day}</td>);
	const forth = props.forth.map((day) => <td date-month="12" date-day={day}>{day}</td>);
	return (<tbody>
                <tr>
                    {first}
                </tr>
